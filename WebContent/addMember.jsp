...
<script type="text/javascript">
	function checkForm() {
		if (!document.newMember.file.value) {
			alert("사진을 등록해주세요");
			return false;
		}
		if (!document.newMember.country.value) {
			alert("국가를 등록해주세요.");
			return false;
		}
		if (!document.newMember.oneintroduction.value) {
			alert("한줄소개를 등록해주세요.");
			return false;
		}
		if (!document.newMember.introduction.value) {
			alert("상세소개를 등록해주세요.");
			return false;
		}
	}
...
%>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"  action="processAddMember.jsp" method="post" enctype ="multipart/form-data">
			<div class="form-group  row">
				<label class="col-sm-2 ">아이디</label>
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id"  value="<%=userID%>" readonly>
				</div>
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input type="text" name="country" id="my-language" class="form-control mr-sm-4" size="30" placeholder="나라이름" required>
				</div>
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<textarea class="form-control" id="oneintroduction" name="oneintroduction" required> </textarea> 
				</div>
			</div>
